...
SP1_TMDb is a Java-based application that interacts with The Movie Database (TMDb) API to retrieve and display information about movies, TV shows, and actors.

## Features

- **Movie Search**: Search for movies by title and retrieve details such as release date, overview, and ratings.
- **TV Show Search**: Find TV shows by name and access information like first air date, overview, and ratings.
- **Actor Search**: Look up actors to view their biographies, filmographies, and other relevant details.
...
Additionally, you'll need a TMDb API key. You can obtain one by creating an account on TMDb and requesting an API key. citeturn0search1
...
3. **Set your TMDb API key**:
   ...
   Open the `src/main/java/dat/ApiKey.java` file and replace `YOUR_API_KEY` with your actual TMDb API key.
